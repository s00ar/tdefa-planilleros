...
export function ScoreboardHeader() {
  ...
  return (
    <div className="sticky top-[84px] z-20 overflow-hidden rounded-2xl border border-[#eadfdd] bg-white/95 shadow-[0_10px_30px_rgba(36,25,23,0.08)] backdrop-blur lg:top-[112px]">
